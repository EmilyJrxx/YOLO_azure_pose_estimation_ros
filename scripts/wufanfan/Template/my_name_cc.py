...
class aubo_vision_pick(object):
    def __init__(self):
        ...
        display_trajectory_publisher = rospy.Publisher('/move_group/planned_path', moveit_msgs.msg.DisplayTrajectory,
                                                       queue_size=20)
    ...
    def write_U(self, scale):
        ...
        wpose.position.z += 0.03
        waypoints.append(copy.deepcopy(wpose))
        wpose.position.x += scale * 0.13
        waypoints.append(copy.deepcopy(wpose))
        wpose.position.z -= 0.03
        waypoints.append(copy.deepcopy(wpose))
        wpose.position.y += scale * 0.10
        waypoints.append(copy.deepcopy(wpose))
        ...
        wpose.position.y -= scale * 0.022
        waypoints.append(copy.deepcopy(wpose))
        wpose.position.z -= 0.03
        waypoints.append(copy.deepcopy(wpose))
        wpose.position.y += scale * 0.044
        waypoints.append(copy.deepcopy(wpose))

        wpose.position.z += 0.03
        waypoints.append(copy.deepcopy(wpose))
        wpose.position.y -= scale * 0.047
        wpose.position.x += scale * 0.06
        waypoints.append(copy.deepcopy(wpose))
        wpose.position.z -= 0.03
        wpose.position.y += scale * 0.1
