...
class aubo_vision_pick(object):
    ...
    def write_F(self, scale):
        ...
        # the second stroke
        wpose.position.z -= 0.03
        wpose.position.y -= scale * 0.05             ####   y,x   return
        waypoints.append(copy.deepcopy(wpose))
    ...
    def write_A(self, scale):
        ...
        # the ** stroke        
        #current_pose.position.x += scale * 0.1
        #waypoints.append(copy.deepcopy(wpose))
        ...
        # define pose with specific parameters
        pose_goal = current_pose
        pose_goal.position.x += 0.1*scale
    ...
    def write_N(self, scale):
        ...
        # the second stroke
        wpose.position.z -= 0.03
        wpose.position.x -= scale * 0.1             ####   y,x   return
        waypoints.append(copy.deepcopy(wpose))
        wpose.position.x += scale * 0.1
