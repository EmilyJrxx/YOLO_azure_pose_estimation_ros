...
class aubo_vision_pick(object):
    ...
    # the 2 stroke
        ...
        waypoints.append(copy.deepcopy(wpose))
        wpose.position.x += scale * 0.015
        wpose.position.y += scale * 0.015
        waypoints.append(copy.deepcopy(wpose))
...
if __name__=="__main__":
    ...
    scale = 0.5
    print "==== Press `Enter` to write xiong ===="
    raw_input()
    aubo_move.write_xiong(scale)
