...
class aubo_vision_pick(object):
    ...
    def go_to_pre_pointA(self):####################PPPPPPRE_AAAAAAAAAA
        group = self.group
    ...
    def go_to_pointA(self):################################AAAAAA
        ...
        # Point Pre_PointB is 0.2m higher than B
    def go_to_pre_pointB(self):####################PPPPPPRE_BBBBBBBBBBB
        group = self.group
        current_pose = group.get_current_pose().pose
        print("Current pose: ", current_pose)
        pose_goal=geometry_msgs.msg.Pose()
...
if __name__=="__main__":
    ...
    print "==== Press `Enter` to grasp again ===="
    raw_input()
    aubo_move.gripper_open()
    aubo_move.go_to_pointB()
    aubo_move.gripper_close()
